...
<head>
	...
	<meta charset="utf-8">
	<meta name="description" content="Tiket.com">
	<meta name="author" content="Bagas Galang">
...
<body id="mimin" class="dashboard form-signin-wrapper">
	...
	<div class="container">
			...
			<div class="panel periodic-login">
				<div class="panel-body text-center">
					...
					<label class="pull-left">
						<input type="checkbox" class="icheck pull-left" name="checkbox1" /> Remember user
					</label>
					<input type="submit" class="btn btn-default btn-raised col-md-12" value="Login" />
				</div>
				<?php
		...
		<br>
		<center>
			<p>dibuat oleh <a href="" title="Bagas Galang" target="_blank"></a>bagas galang</p>
		</center>
	</div>
